"""Remove the "YAŞATMA İDEALİ" title, the ribbon text, the number and the author name (LaMa, solid box masks).
...
SRC = HERE / "kirik-11-source.webp"
DST = HERE / "kirik-notitle-source.png"
BOXES = [(150, 130, 680, 330),      # title (two lines of serif capitals)
         (306, 362, 522, 400),      # "KIRIK TESTİ" on the gold ribbon (ribbon stays)
         (380, 410, 455, 480),      # volume number
         (125, 1030, 700, 1082)]    # author name
CONTEXT = (16, 1216)                # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (27, 824)                    # cover only
