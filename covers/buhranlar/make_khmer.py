"""Khmer edition of the "Buhranlar anaforunda İnsan" (Çağ ve Nesil 2) cover on the original artwork (title removed by erase_title.py).

    python3 make_khmer.py [--hd] [--font Freehand] 2
Uses the no-author artwork (../erase_author.py). Writes khmer-N.png (704x1050) or khmer-N-hd.png (2816x4200).
"""
import sys
...
SOURCE = HERE / "buhranlar-notitle-source-noauthor.png"
SOURCE_HD = HERE / "buhranlar-notitle-source-4x-noauthor.png"

COVER = (3, 10, 707, 1060)            # cover inside the app frame (source px)
CORNER = 12

# មនុស្ស ក្នុងទឹកគួចនៃវិបត្តិ — "Man in the whirlpool of crises" (Buhranlar anaforunda İnsan);
# three lines like the original: big / small / big, light cream script with a soft dark shadow.
TITLE = [
    # text, max width, ink height, center x, center y, unused
    ("មនុស្ស", 300, 120, 400, 428, 1.0),
    ("ក្នុងទឹកគួច", 330, 70, 410, 540, 1.0),
    ("នៃវិបត្តិ", 330, 115, 415, 640, 1.0),
]
INK = (254, 241, 200)
SHADOW = (70, 30, 5)

# volume box
PATCH = (598, 918, 684, 1016)
DIGIT_CENTER_X, DIGIT_BOTTOM, DIGIT_HEIGHT = 639, 1006, 78
...
if __name__ == "__main__":
    ...
    for v in [a for a in args if a != "--hd"] or ["2"]:
