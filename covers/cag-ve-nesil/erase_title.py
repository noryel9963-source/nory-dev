"""Remove the "Çağ ve Nesil" calligraphy title and the small series logo with LaMa inpainting.
...
SRC = HERE / "cag-ve-nesil-1-source.webp"
DST = HERE / "cag-ve-nesil-notitle-source.png"
REGIONS = [(180, 860, 870, 1265), (920, 1255, 1045, 1352)]   # title, series logo (source px)
CONTEXT = (700, 1356)                                        # rows handed to LaMa (multiple of 8 tall)
