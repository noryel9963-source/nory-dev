"""Remove the "vuslat muştusu" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-8-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (195, 705, 590, 960)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(200, 1066, 565, 1138),    # author name on the yellow band
         (650, 1040, 805, 1172)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (8, 1200)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (10, 809)                    # cover only
