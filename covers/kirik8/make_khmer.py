"""Khmer edition of "Vuslat Muştusu" (Kırık Testi 8): ដំណឹងរីករាយ នៃការជួបជុំ (proposed; the translators' words).

    python3 make_khmer.py [--hd] 1 2 ...
Writes khmer-N.png (799x1196) or khmer-N-hd.png (3196x4784). Default volume 8.
"""
import sys
...
LINES = [
    ("ដំណឹងរីករាយ", "Siemreap.ttf", 440, 115, 770, (158, 24, 14), None),      # vuslat (dark red)
    ("នៃការជួបជុំ", "Siemreap.ttf", 400, 105, 890, (78, 25, 14), None),       # muştusu (dark brown)
]

# number box: big orange digit with the series name in small letters on both sides (like "KIRIK 1 TESTİ")
NUM_CX, NUM_BOTTOM, NUM_H = 705, 1141, 82
NUM_COLOR = (223, 144, 49)
SIDE = [("ក្អម", 668, 1104), ("បែក", 745, 1104)]    # text, centre x, centre y
SIDE_H = 13
