"""Remove the "ikindi yağmurları" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-5-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (150, 700, 640, 965)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(200, 1070, 570, 1138),    # author name on the yellow band
         (660, 1045, 810, 1175)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
