"""Remove the dark "KENDİ İKLİMİMİZ" title (over the bright map) and the Prizma series logo with LaMa.
...
SRC = HERE / "kendi-5-source.webp"
DST = HERE / "kendi-notitle-source.png"
TITLE = (120, 370, 725, 610)        # dark navy serif capitals (masked by ink detection)
BOXES = [(660, 910, 805, 1028)]     # series logo: prism + small PRİZMA
CONTEXT = (304, 1032)               # rows handed to LaMa (multiple of 8 tall; stops above the band)
COLOR_MATCH = 0.0
COLS = (23, 815)                    # cover only: keep the navy frame out of LaMa's context
