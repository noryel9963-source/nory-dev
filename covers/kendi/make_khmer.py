...
SOURCE = HERE / "kendi-notitle-source-noauthor.png"
SOURCE_HD = HERE / "kendi-notitle-source-4x-noauthor.png"

COVER = (23, 17, 815, 1204)           # cover inside the app frame (source px)
CORNER = 12
...
TITLE = [
    ...
    ("ផ្ទាល់ខ្លួនរបស់យើង", 600, 105, 425, 590, 1.0),
]
INK = (0, 24, 72)
SHADOW = (255, 255, 255)
GLOW = True                           # centred white halo instead of an offset drop shadow

# volume box (teal box, light cyan digit)
PATCH = (688, 1050, 782, 1160)
DIGIT_CENTER_X, DIGIT_BOTTOM, DIGIT_HEIGHT = 733, 1146, 87
DIGIT_COLOR = (102, 209, 225)
