"""Remove the dark "ÇİZGİMİZİ HECELERKEN" title (over the bright light burst) and the Prizma series logo with LaMa.
...
SRC = HERE / "cizgimizi-8-source.webp"
DST = HERE / "cizgimizi-notitle-source.png"
TITLE = (150, 640, 880, 915)        # dark navy capitals + swash Ç (masked by ink detection)
BOXES = [(840, 1150, 1002, 1290)]    # series logo: prism + PRİZMA
CONTEXT = (400, 1296)               # rows handed to LaMa (multiple of 8; stops above the band)
COLOR_MATCH = 0.0
COLS = (25, 1020)                   # cover only
