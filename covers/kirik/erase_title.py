"""Remove the "kırık testi" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-1-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (270, 640, 570, 895)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(205, 1078, 570, 1148),    # author name on the yellow band
         (662, 1040, 802, 1170)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (8, 1200)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (15, 814)                    # cover only
