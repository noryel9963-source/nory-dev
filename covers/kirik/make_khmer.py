"""Khmer edition of the "Kırık Testi" cover: ក្អមបែក, the title the Khmer translation itself uses.

    python3 make_khmer.py [--hd] 1 2 ...
Writes khmer-N.png (799x1196) or khmer-N-hd.png (3196x4784).
"""
import sys
...
LINES = [
    ("ក្អម", "Siemreap.ttf", 300, 120, 700, (158, 24, 14), None),    # kırık (dark red)
    ("បែក", "Siemreap.ttf", 300, 120, 830, (78, 25, 14), None),     # testi (dark brown)
]

# number box: big orange digit with the series name in small letters on both sides (like "KIRIK 1 TESTİ")
NUM_CX, NUM_BOTTOM, NUM_H = 711, 1144, 82
NUM_COLOR = (223, 144, 49)
SIDE = [("ក្អម", 676, 1110), ("បែក", 752, 1110)]    # text, centre x, centre y
SIDE_H = 13
