"""Remove the "kalb ibresi" title (over the sky), the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-9-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (255, 185, 615, 450)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(205, 1080, 565, 1146),    # author name on the yellow band
         (655, 1045, 808, 1178)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1208)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (15, 812)                    # cover only
