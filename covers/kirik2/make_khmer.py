"""Khmer edition of "Sohbet-i Cânan" (Kırık Testi 2): ការសន្ទនាជាមួយដួងព្រលឹងជាទីស្រឡាញ់, the translation's own heading.

    python3 make_khmer.py [--hd] 1 2 ...
Writes khmer-N.png (799x1196) or khmer-N-hd.png (3196x4784). Default volume 2.
"""
import sys
...
COVER = (34, 11, 833, 1207)
CORNER = 12
CX = 415

# text, font, max width, ink height, centre y, colour, shadow colour (None = no shadow)
LINES = [
    ("ការសន្ទនា", "Siemreap.ttf", 380, 100, 750, (158, 24, 14), None),          # sohbet-i (dark red)
    ("ជាមួយដួងព្រលឹង", "Siemreap.ttf", 400, 78, 845, (78, 25, 14), None),     # cânan (dark brown)
    ("ជាទីស្រឡាញ់", "Siemreap.ttf", 330, 78, 925, (78, 25, 14), None),
]

# number box: big orange digit with the series name in small letters on both sides (like "KIRIK 1 TESTİ")
NUM_CX, NUM_BOTTOM, NUM_H = 737, 1146, 82
NUM_COLOR = (223, 144, 49)
SIDE = [("ក្អម", 700, 1110), ("បែក", 778, 1110)]    # text, centre x, centre y
SIDE_H = 13
