"""Remove the "sohbet-i cânan" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-2-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (215, 705, 620, 945)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(225, 1082, 585, 1150),    # author name on the yellow band
         (682, 1045, 826, 1172)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1200)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (34, 833)                    # cover only
