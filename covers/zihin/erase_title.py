"""Remove the light "ZİHİN HARMANI" title and the series logo (prism + PRİZMA) with LaMa.
...
SRC = HERE / "zihin-7-source.webp"
DST = HERE / "zihin-notitle-source.png"
TITLE = (170, 630, 870, 935)        # light serif capitals (masked by ink detection)
BOXES = [(835, 1135, 1000, 1268)]    # series logo: prism + small PRİZMA
CONTEXT = (400, 1272)               # rows handed to LaMa (multiple of 8 tall; stops above the band)
COLOR_MATCH = 1.0                   # the fill comes out slightly darker here; match local colour
COLS = (27, 1020)                   # cover only
