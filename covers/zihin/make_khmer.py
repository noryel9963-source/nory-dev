...
SOURCE = HERE / "zihin-notitle-source-noauthor.png"
SOURCE_HD = HERE / "zihin-notitle-source-4x-noauthor.png"

COVER = (27, 4, 1020, 1491)           # cover inside the app frame (source px)
CORNER = 14
...
TITLE = [
    ...
    ("នៃគំនិត", 460, 150, 518, 880, 1.0),
]
INK = (213, 240, 255)
SHADOW = (5, 20, 60)

# volume box (teal box, light cyan digit)
PATCH = (842, 1292, 1000, 1444)
DIGIT_CENTER_X, DIGIT_BOTTOM, DIGIT_HEIGHT = 925, 1420, 114
DIGIT_COLOR = (99, 209, 228)
