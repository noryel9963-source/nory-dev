"""Remove the "mefkûre yolculuğu" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-13-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (140, 455, 670, 738)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(345, 435, 445, 485),     # circumflex over û
         (205, 1070, 560, 1140),    # author name on the yellow band
         (648, 1045, 808, 1178)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1208)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (13, 811)                    # cover only
