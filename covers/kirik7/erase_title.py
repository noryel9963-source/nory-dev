"""Remove the "ölümsüzlük iksiri" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-7-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (140, 700, 650, 950)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(200, 1068, 565, 1140),    # author name on the yellow band
         (650, 1045, 805, 1178)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
