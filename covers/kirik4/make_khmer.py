"""Khmer edition of "Ümit Burcu" (Kırık Testi 4): «ប៉មនៃក្ដីសង្ឃឹម», the title the translation's foreword gives.

    python3 make_khmer.py [--hd] 1 2 ...
Writes khmer-N.png (799x1196) or khmer-N-hd.png (3196x4784). Default volume 4.
"""
import sys
...
NUM_CX, NUM_BOTTOM, NUM_H = 718, 1159, 82
NUM_COLOR = (223, 144, 49)
SIDE = [("ក្អម", 683, 1118), ("បែក", 760, 1118)]    # text, centre x, centre y
SIDE_H = 13
...
if __name__ == "__main__":
    args = sys.argv[1:]
    hd = "--hd" in args
    for v in [a for a in args if a != "--hd"] or ["4"]:
