"""Remove the "cemre beklentisi" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-10-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (120, 715, 690, 965)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(210, 1072, 575, 1142),    # author name on the yellow band
         (655, 1045, 815, 1178)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1208)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (20, 819)                    # cover only
