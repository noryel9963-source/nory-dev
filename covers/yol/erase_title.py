"""Remove the dark "YOL MÜLÂHAZALARI" title (over the bright sun) and the Prizma series logo with LaMa.
...
SRC = HERE / "yol-6-source.webp"
DST = HERE / "yol-notitle-source.png"
TITLE = (200, 360, 640, 650)        # dark navy capitals (masked by ink detection)
BOXES = [(680, 955, 830, 1068)]     # series logo: prism + PRİZMA
CONTEXT = (320, 1072)               # rows handed to LaMa (multiple of 8; stops above the band)
COLOR_MATCH = 0.0
COLS = (18, 842)                    # cover only
