"""Remove the "gurbet ufukları" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-3-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (210, 705, 605, 950)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(200, 1080, 565, 1146),    # author name on the yellow band
         (662, 1045, 808, 1175)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1208)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (14, 813)                    # cover only
