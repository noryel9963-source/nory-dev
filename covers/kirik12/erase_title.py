"""Remove the "yenilenme cehdi" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-12-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (110, 690, 700, 950)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(205, 1076, 560, 1146),    # author name on the yellow band
         (648, 1045, 808, 1180)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1208)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (12, 811)                    # cover only
