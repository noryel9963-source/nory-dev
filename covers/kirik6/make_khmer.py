"""Khmer edition of "Diriliş Çağrısı" (Kırık Testi 6): ការអំពាវនាវ នៃការរស់ឡើងវិញ (proposed; the translation's words).

    python3 make_khmer.py [--hd] 1 2 ...
Writes khmer-N.png (799x1196) or khmer-N-hd.png (3196x4784). Default volume 6.
"""
import sys
...
COVER = (24, 14, 823, 1209)
CORNER = 12
CX = 407

# text, font, max width, ink height, centre y, colour, shadow colour (None = no shadow)
LINES = [
    ("ការអំពាវនាវ", "Siemreap.ttf", 400, 115, 775, (158, 24, 14), None),       # diriliş (dark red)
    ("នៃការរស់ឡើងវិញ", "Siemreap.ttf", 440, 110, 895, (78, 25, 14), None),   # çağrısı (dark brown)
]

# number box: big orange digit with the series name in small letters on both sides (like "KIRIK 1 TESTİ")
NUM_CX, NUM_BOTTOM, NUM_H = 733, 1153, 84
NUM_COLOR = (223, 144, 49)
SIDE = [("ក្អម", 697, 1112), ("បែក", 776, 1112)]    # text, centre x, centre y
SIDE_H = 13
