"""Remove the "diriliş çağrısı" title, the author name and the number box contents ("KIRIK 1 TESTİ") with LaMa.
...
SRC = HERE / "kirik-6-source.webp"
DST = HERE / "kirik-notitle-source.png"
TITLE = (230, 705, 580, 975)        # dark red / brown lower-case title (masked by ink detection)
BOXES = [(210, 1082, 580, 1150),    # author name on the yellow band
         (664, 1050, 818, 1180)]    # number box contents: small "KIRIK", big "1", small "TESTİ"
CONTEXT = (16, 1200)                 # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (24, 823)                    # cover only
