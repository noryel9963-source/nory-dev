"""Remove the series label, subtitle, "NAMAZ" title, author name and Süreyya logo (LaMa, solid box masks).
...
SRC = HERE / "namaz-source.webp"
DST = HERE / "namaz-notitle-source.png"
BOXES = [(268, 118, 574, 152),      # "İBADET HAYATIMIZ" letters (the thin gold lines above/below stay)
         (215, 178, 630, 243),      # "Miraç Enginlikli İbadet"
         (112, 238, 722, 369),      # "NAMAZ" + shadow
         (150, 384, 690, 445),      # author name
         (370, 1088, 468, 1183)]    # Süreyya logo
CONTEXT = (16, 1240)                # rows handed to LaMa (multiple of 8)
COLOR_MATCH = 0.0
COLS = (20, 835)                    # cover only
